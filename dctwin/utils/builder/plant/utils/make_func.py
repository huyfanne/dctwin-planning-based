...
def make_pump(
    ...
    **kwargs,
    ...
    :return:
    """
    obj: EpBunch = model.newidfobject("Pump:VariableSpeed".upper(), Name=pump.uid.lower())
    obj = fill_inlet_outlet(
        branch_component_idx=branch_component_idx,
        obj=obj,
        branch=branch,
    ...
    obj["Design_Minimum_Flow_Rate_Fraction"] = pump.cooling.design_minimum_flow_rate_fraction
    ...
    obj["Design_Electric_Power_per_Unit_Flow_Rate"] = pump.power.design_electric_power_per_unit_flow_rate
...
def make_cooling_coil(
    ...
    **kwargs,
    ...
    :return:
    """
    obj = model.getobject("coil:cooling:water".upper(), f"{acu.uid.lower()} cooling coil")
    assert obj is not None, f"Cannot find the cooling coil object: {acu.uid.lower()} cooling coil"
    obj = fill_inlet_outlet(
        obj=obj,
        branch=branch,
    ...
    coil_controller = model.getobject("Controller:WaterCoil".upper(), f"{acu.uid.lower()} controller")
...
def make_chiller(
    ...
    **kwargs,
    ...
    if kwargs["type_"] == "chilled" and kwargs["side"] == "supply":
        obj = model.newidfobject("chiller:electric:eir".upper(), Name=chiller.uid.lower())
        obj = fill_inlet_outlet(
            branch_component_idx=branch_component_idx,
            obj=obj,
            branch=branch,
        ...
        obj["Reference_Chilled_Water_Flow_Rate"] = chiller.cooling.reference_chilled_water_flow_rate
        obj["Reference_Condenser_Fluid_Flow_Rate"] = chiller.cooling.reference_condenser_fluid_flow_rate
        ...
        obj["Basin_Heater_Setpoint_Temperature"] = chiller.cooling.basin_heater_setpoint_temperature
        obj["Design_Heat_Recovery_Water_Flow_Rate"] = chiller.cooling.design_heat_recovery_water_flow_rate
        ...
        model.newidfobject(
            ...
            Coefficient1_Constant=chiller.cooling.cooling_capacity_function_of_temperature_curve[0],
            Coefficient2_x=chiller.cooling.cooling_capacity_function_of_temperature_curve[1],
            Coefficient3_x2=chiller.cooling.cooling_capacity_function_of_temperature_curve[2],
            Coefficient4_y=chiller.cooling.cooling_capacity_function_of_temperature_curve[3],
            Coefficient5_y2=chiller.cooling.cooling_capacity_function_of_temperature_curve[4],
            Coefficient6_xy=chiller.cooling.cooling_capacity_function_of_temperature_curve[5],
            Minimum_Value_of_x=0,
            Maximum_Value_of_x=100,
            Minimum_Value_of_y=0,
            Maximum_Value_of_y=100,
        )
        obj["Electric_Input_to_Cooling_Output_Ratio_Function_of_Temperature_Curve_Name"] =\
            f"{chiller.uid.lower()} electric input to cooling output ratio function of temperature curve"
        model.newidfobject(
            key="Curve:Biquadratic".upper(),
            Name=obj["Electric_Input_to_Cooling_Output_Ratio_Function_of_Temperature_Curve_Name"],
            Coefficient1_Constant=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[0],
            Coefficient2_x=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[1],
            Coefficient3_x2=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[2],
            Coefficient4_y=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[3],
            Coefficient5_y2=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[4],
            Coefficient6_xy=chiller.power.electric_input_to_cooling_output_ratio_function_of_temperature_curve[5],
            Minimum_Value_of_x=0,
            Maximum_Value_of_x=100,
            Minimum_Value_of_y=0,
            Maximum_Value_of_y=100,
        )
        obj["Electric_Input_to_Cooling_Output_Ratio_Function_of_Part_Load_Ratio_Curve_Name"] =\
            f"{chiller.uid.lower()} electric input to cooling output ratio function of part load ratio curve"
        model.newidfobject(
            key="Curve:Quadratic".upper(),
            Name=obj["Electric_Input_to_Cooling_Output_Ratio_Function_of_Part_Load_Ratio_Curve_Name"],
            Coefficient1_Constant=chiller.power.electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve[0],
            Coefficient2_x=chiller.power.electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve[1],
            Coefficient3_x2=chiller.power.electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve[2],
            Minimum_Value_of_x=0,
...
def make_cooling_tower(
    ...
    **kwargs,
    ...
    obj["Basin_Heater_Operating_Schedule_Name"] = cooling_tower.cooling.basin_heater_operating_schedule_name
    obj["Basin_Heater_Setpoint_Temperature"] = cooling_tower.cooling.basin_heater_setpoint_temperature
    obj["Blowdown_Calculation_Mode"] = cooling_tower.cooling.blowdown_calculation_mode
    obj["Blowdown_Concentration_Ratio"] = cooling_tower.cooling.blowdown_concentration_ratio
    obj["Blowdown_Makeup_Water_Usage_Schedule_Name"] = cooling_tower.cooling.blowdown_makeup_water_usage_schedule_name

    obj["Number_of_Cells"] = cooling_tower.cooling.number_of_cells
    obj["Cell_Control"] = cooling_tower.cooling.cell_control
    obj["Cell_Minimum_Water_Flow_Rate_Fraction"] = cooling_tower.cooling.cell_minimum_water_flow_rate_fraction
    obj["Cell_Maximum_Water_Flow_Rate_Fraction"] = cooling_tower.cooling.cell_maximum_water_flow_rate_fraction
    ...
    model.newidfobject(
        ...
        Coefficient1_Constant=cooling_tower.power.fan_power_ratio_function_of_air_flow_rate_ratio_curve[0],
        Coefficient2_x=cooling_tower.power.fan_power_ratio_function_of_air_flow_rate_ratio_curve[1],
        Coefficient3_x2=cooling_tower.power.fan_power_ratio_function_of_air_flow_rate_ratio_curve[2],
        Coefficient4_x3=cooling_tower.power.fan_power_ratio_function_of_air_flow_rate_ratio_curve[3],
        Minimum_Value_of_x=0,
        Maximum_Value_of_x=1,
    )
    return obj
